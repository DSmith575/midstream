...
export const referralFormFirstLanguageOptions: Array<string> = [
  'Arabic',
  'Bengali',
  'Chinese',
  'English',
...
export const referralFormDisabilityOptions: Array<string> = [
  'Blindness',
  'Low Vision',
...
export const yesOrNo: Array<string> = ['Yes', 'No']

export const referrerRelationshipOptions: Array<string> = [
  'Self',
  'Parent',
  'Guardian',
  'Family Member',
...
export const referralFormSteps: Array<Steps> = [
  {
    id: 'Step 1',
