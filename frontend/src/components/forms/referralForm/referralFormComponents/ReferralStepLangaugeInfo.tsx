...
import FormTextArea from "@/components/forms/profileForm/profileFormComponents/FormTextArea";
import FormSelect from "@/components/forms/profileForm/profileFormComponents/FormSelect";
...
export default StepLanguageInfo;
