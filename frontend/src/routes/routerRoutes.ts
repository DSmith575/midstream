...
export const routerRoutes: RouterPathProps = {
	...
	dashboardUser: { path: routerConstants.dashboardUser.path, name: routerConstants.dashboardUser.name },
	dashboardUserEdit: { path: routerConstants.dashboardUserEdit.path, name: routerConstants.dashboardUserEdit.name },
};